...
const BestSeller = ({ mostSelled }) => {
  const [loading, setLoading] = useState(false);

  useEffect(() => {
    mostSelled ? setLoading(false) : setLoading(true);
  });

  return (
    <div className="best-seller">
      <div className="bestseller-heading">
        <h4 className="bestsller-h">Ən çox satılan məhsullar</h4>
        <div className="show-all">
          <Link className="showall-link" to="/products/bestselled">
            Hamısına bax
          </Link>
