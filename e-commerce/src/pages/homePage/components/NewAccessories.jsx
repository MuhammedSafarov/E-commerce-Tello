...
const NewAccessories = ({ newAccessories }) => {
  const [loading, setLoading] = useState(false);
  useEffect(() => {
    newAccessories ? setLoading(false) : setLoading(true);
  });

  return (
    <div className="best-seller">
      <div className="bestseller-heading">
        <h4 className="bestsller-h">Yeni gələn aksessuarlar</h4>
        <div className="show-all">
          <Link className="showall-link" to="/products/accsessories">
            Hamısına bax
          </Link>
